...
CREATE TABLE IF NOT EXISTS public.provider_api_keys (
    ...
    sla_eligible_count bigint DEFAULT 0,
    success_count bigint DEFAULT 0,
    error_count bigint DEFAULT 0,
    user_error_count bigint DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS public.stats_daily (
    ...
    sla_eligible_requests bigint DEFAULT 0 NOT NULL,
    success_requests integer DEFAULT 0 NOT NULL,
    error_requests integer DEFAULT 0 NOT NULL,
    user_error_requests bigint DEFAULT 0 NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.stats_summary (
    ...
    all_time_sla_eligible_requests bigint DEFAULT 0 NOT NULL,
    all_time_success_requests integer DEFAULT 0 NOT NULL,
    all_time_error_requests integer DEFAULT 0 NOT NULL,
    all_time_user_error_requests bigint DEFAULT 0 NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.usage (
    ...
    outcome_class character varying(32) DEFAULT 'in_flight'::character varying NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.usage_counter_deltas (
    ...
    sla_eligible_count_delta bigint DEFAULT 0 NOT NULL,
    error_count_delta bigint DEFAULT 0 NOT NULL,
    user_error_count_delta bigint DEFAULT 0 NOT NULL,
