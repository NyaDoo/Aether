...
CREATE TABLE IF NOT EXISTS asset_groups (
    ...
    PRIMARY KEY (`id`),
    UNIQUE KEY uq_asset_groups_upstream (`provider_id`, `account_binding`, `project`, `upstream_group_id`),
...
CREATE TABLE IF NOT EXISTS ark_visual_validation_sessions (
    ...
    `updated_at_unix_secs` BIGINT NOT NULL,
    PRIMARY KEY (`id`),
    UNIQUE KEY uq_ark_validation_upstream (`provider_id`, `account_binding`, `project`, `session_id`),
