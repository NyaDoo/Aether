pub use crate::contracts::{
    ...
    CLAUDE_COUNT_TOKENS_SYNC_SUCCESS_REPORT_KIND, DOUBAO_VIDEO_CONTENT_PLAN_KIND,
    DOUBAO_VIDEO_CREATE_SYNC_FINALIZE_REPORT_KIND, DOUBAO_VIDEO_CREATE_SYNC_PLAN_KIND,
    DOUBAO_VIDEO_DELETE_SYNC_FINALIZE_REPORT_KIND, DOUBAO_VIDEO_DELETE_SYNC_PLAN_KIND,
...
pub use crate::formats::{
    ...
    shared::video_conversion::convert_openai_video_request_to_doubao,
};
