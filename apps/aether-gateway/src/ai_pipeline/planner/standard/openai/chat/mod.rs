...
pub(crate) async fn build_local_openai_chat_sync_plan_and_reports_for_kind(
    ...
    plan_kind: &str,
) -> Result<Vec<crate::ai_pipeline::planner::plan_builders::LocalSyncPlanAndReport>, GatewayError> {
...
pub(crate) async fn build_local_openai_chat_stream_plan_and_reports_for_kind(
    ...
    body_json: &serde_json::Value,
    plan_kind: &str,
) -> Result<Vec<crate::ai_pipeline::planner::plan_builders::LocalStreamPlanAndReport>, GatewayError>
{
