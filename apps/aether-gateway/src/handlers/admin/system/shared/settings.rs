...
const AETHER_RELEASES_API_URL: &str =
    "https://api.github.com/repos/NyaDoo/Aether/releases?per_page=20";
const AETHER_RELEASE_TAG_URL_BASE: &str = "https://github.com/NyaDoo/Aether/releases/tag";
...
mod tests {
    ...
    fn github_release_tag_url_points_to_explicit_tag_page() {
        assert_eq!(
            ...
            "https://github.com/NyaDoo/Aether/releases/tag/v0.7.3"
        );
    }
