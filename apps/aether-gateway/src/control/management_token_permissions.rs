...
fn permission_key(scope: &str, access: &str) -> &'static str {
    match (scope, access) {
        ...
        ("material_assets", "read") => "admin:material_assets:read",
        ("material_assets", "write") => "admin:material_assets:write",
        ("material_assets", "admin") => "admin:material_assets:admin",
