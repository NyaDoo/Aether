...
/// Internal, per-request identity for realtime RPM admission accounting.
/// Unlike `TRACE_ID_HEADER`, this value is always generated by the gateway
/// and is never accepted from a client.
pub(crate) const REALTIME_ADMISSION_ID_HEADER: &str = "x-aether-realtime-admission-id";
pub(crate) const REALTIME_ADMISSION_AT_MS_HEADER: &str = "x-aether-realtime-admission-at-ms";
